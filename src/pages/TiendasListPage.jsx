...
const TiendasListPage = () => {
  const { tiendas, getAllTiendas, loading } = useContext(TiendaContext);
        ...
        <>
          ...
          <div className="d-flex justify-content-around m-4">
            ...
            <span className="badge rounded-pill text-bg-danger">
              Tiendas Inactivas: {console.log(tiendasInactivas())}
            </span>
          </div>
                    ...
                    <div className="d-flex justify-content-around">
                      <span
                        className={`badge rounded-pill text-bg-${
                          tienda.estado ? "success" : "danger"
                        }`}
                      >
                        Estado:{tienda.estado ? "Activa" : "Inactiva"}
                      </span>
                      <span className={`badge rounded-pill text-bg-light`}>
                        Registro:{tienda.fecha_registro}
                      </span>
                    </div>
