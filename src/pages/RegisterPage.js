                ...
                <div>
                    <form onSubmit={handleSubmit}>
                        <div className="mb-2">
                            ...
                            <input onChange={handleChange} type="text" name='username' className="form-control" required />
                        </div>
                        ...
                        <div className='mb-2'>
                            ...
                            <input onChange={handleChange} name='nombre_ruta' type='text' className='form-control'  required/>
                        </div>
                       
                        <div className='d-grid gap-2 col-6 mx-auto'>
                            <button className='btn btn-success' type='submit'>Crear Ruta</button>
                        </div>
                    </form>
                </div>
            </div>
