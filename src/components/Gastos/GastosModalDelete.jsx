...
const GastosModalDelete = () => {
  const { gasto, openModalDelete, gastoDeleteItem, openModalDeleteGasto } =
  ...
  return (
    <Modal isOpen={openModalDelete} toggle={openModalDeleteGasto}>
      ...
      <ModalFooter>
        <Button onClick={gastoDeleteItem} color="danger">
          Confirmar
        </Button>
        <Button onClick={openModalDeleteGasto} color="secondary">
          Cancelar
        </Button>
      </ModalFooter>
    </Modal>
