          ...
          <div>
            ...
            <div className='alert alert-light'>
              ...
              <p>Estado Suscripción: {tienda.estado == 'Vencida'?
                                      <span className='badge bg-danger'>{tienda.estado}</span>:tienda.estado == 'Pendiente Pago'?
            ...
            <p className='alert alert-primary'>Para activar la cuenta comunicarse al WhatsApp <a href='https://api.whatsapp.com/send?phone=56963511337' target='_blank'>+56963511337</a></p>
