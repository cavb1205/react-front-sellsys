        ...
        <form onSubmit={handleSubmit}>
            ...
            <ModalBody>
                <FormGroup>
                    ...
                    <Input onChange={handleChange} type='date' name='fecha_recaudo' value={newRecaudo.fecha_recaudo} className='form-control' required/>
                </FormGroup>
                <FormGroup>
                    <Label>
                        Valor:
                    </Label>
                    <Input onChange={handleChange} type='number' name='valor_recaudo' value={newRecaudo.valor_recaudo} className='form-control' required/>
                </FormGroup>
            </ModalBody>
            <ModalFooter>
