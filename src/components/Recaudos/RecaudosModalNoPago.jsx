...
const RecaudosModalNoPago = () => {
  ...
  return (
    <Modal
      isOpen={openModalNoPago}
      toggle={() => setOpenModalNoPago(!openModalNoPago)}
    >
      ...
      <ModalFooter>
        <button onClick={recaudosCreateNoPago} className="btn btn-success">
          Confirmar
        </button>
        <button
          onClick={() => setOpenModalNoPago(!openModalNoPago)}
