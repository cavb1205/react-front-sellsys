  ...
  return (
    <Modal isOpen={openModal} toggle={openModalCierreCaja}>
      <ModalHeader toggle={openModalCierreCaja}>
        Cierre Caja <input type='date' value={fecha} onChange={dateChange} className='btn btn-outline-primary btn-sm mx-3 mb-1' />
        <br />
        {!cajaAnterior.valor
          ? <small className='badge rounded-pill text-bg-danger'>No se ha cerrado la caja del día anterior!!</small>
          : null}
      </ModalHeader>
