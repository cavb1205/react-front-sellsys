...
const CierreCajaModalDelete = () => {
  const { openModalDelete, openModalDeleteCierre, cierre, deleteCierresCaja } =
  ...
  return (
    <Modal isOpen={openModalDelete} toggle={openModalDeleteCierre}>
      ...
      <ModalFooter>
        <button
          onClick={() => deleteCierresCaja(cierre.id)}
          className="btn btn-danger"
        >
          Eliminar
        </button>
        <button onClick={openModalDeleteCierre} className="btn btn-secondary">
          Cancelar
        </button>
      </ModalFooter>
    </Modal>
