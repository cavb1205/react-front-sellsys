...
const VentasDetailPage = () => {
  ...
  return (
    <div className="container-sm">
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="card-footer d-flex flex-wrap justify-content-around">
                    ...
                    <button
                      onClick={openModalDeleteVenta}
                      className="btn btn-danger mb-2"
                    >
                      Eliminar
                    </button>
                    <Link to="/liquidar/" className="btn btn-secondary mb-2">
                      Lista Ventas
                    </Link>
                  </div>
      ...
      <VentasModalPerdida
        venta={ventaDetail}
        clickOpenModalPerdida={clickOpenModalPerdida}
        openModalPerdida={openModalPerdida}
      />
    </div>
  );
};
