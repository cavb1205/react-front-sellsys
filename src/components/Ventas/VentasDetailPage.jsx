            ...
            <div className='tab-pane fade show active' id='detailVenta' role='tabpanel'>
              {
                        loading
                          ...
                          : <>
                            ...
                            {ventaDetail.comentario
                              ? (<div className='row justify-content-around my-2'><div className='col-5'><strong>Cuotas:</strong></div><div className='col-5'><span>{ventaDetail.cuotas}</span></div></div>)
                              : null}
                            <div className='row justify-content-around my-2'>
                              <div className='col-5'>
                            ...
                            ventaDetail.estado_venta === 'Vencido'
                              ...
                              : ventaDetail.estado_venta === 'Atrasado'
                                ...
                                : ventaDetail.estado_venta === 'Vigente'
                                  ? <span className='badge rounded-pill bg-success'>{ventaDetail.estado_venta}</span>
                        ...
                        ventaDetail.estado_venta === 'Perdida'
                          ? <div className='row justify-content-around my-2'><div className='col-5'><strong>Valor Pérdida:</strong></div><div className='col-5'><span className='badge rounded-pill bg-danger'>{ventaDetail.perdida}</span></div></div>
                          : null
                    }
                            {
                        ventaDetail.comentario
                          ? <div className='row justify-content-around my-2'><div className='col-5'><strong>Comentario:</strong></div><div className='col-5'><span className='text-secondary'>{ventaDetail.comentario}</span></div></div>
                          : null
                    }
